                                ...
                                if (substr($fichier, 0, strlen($_GET['prenomRes'])) == $_GET['prenomRes']) {
                                    ...
                                    if ($id_exercice !== null) {
                                        ...
                                        if ($exercice_info) {
                                            ...
                                            // Correction : Ajout de "addition/" devant historique/
                                            $historique_path = urlencode("addition/historique/" . $id_exercice . ".txt");
                                            
                                            echo '<a href="../infos_exos.php?historique=' . $historique_path . '">'
                                                 . $exercise_type . ' - Score: ' . $score . ' - Date: ' . $date . '</a> : ';
                                        } else {
                                            echo '<a href="../infos_exos.php?historique=' . urlencode("addition/historique/" . $id_exercice . ".txt") . '">'
                                                 . 'Exercice inconnu</a> : ';
                                        }
                                    } else {
